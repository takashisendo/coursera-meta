...
- "src-layout": a directory representing a Python lab3_1 that contains a "src"
  folder. Everything under the "src" folder is meant to be included in the
  distribution when packaging the lab3_1. Example::
...
- "flat-layout": a Python lab3_1 that does not use "src-layout" but instead
  have a directory under the lab3_1 root for each package::
...
- "single-module": a lab3_1 that contains a single Python script direct under
  the lab3_1 root (no directory used)::
...
class ConfigDiscovery:
    ...
    def __call__(self, force=False, name=True, ignore_ext_modules=False):
        ...
        To repeatedly invoke automatic discovery (e.g. when the lab3_1
    ...
    def _analyse_flat_layout(self) -> bool:
        """Try to find all packages and modules under the lab3_1 root.
