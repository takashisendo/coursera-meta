...
class LinkEvaluator:
    ...
    """
    Responsible for evaluating links for a particular lab3_1.
    """
    ...
    def evaluate_link(self, link: Link) -> Tuple[bool, Optional[str]]:
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if canonicalize_name(wheel.name) != self._canonical_name:
                    reason = "wrong lab3_1 name (not {})".format(self.project_name)
                    return (False, reason)
        ...
        if not version:
            reason = f"Missing lab3_1 version for {self.project_name}"
            return (False, reason)
...
def filter_unallowed_hashes(
    ...
    if not hashes:
        logger.debug(
            "Given no hashes to check %s links for lab3_1 %r: "
    ...
    logger.debug(
        "Checked %s links for lab3_1 %r against %s hashes "
...
class PackageFinder:
    ...
    def process_project_url(
        ...
        logger.debug(
            "Fetching lab3_1 page and analyzing links: %s",
            project_url,
        )
    ...
    def find_best_candidate(
        ...
        """Find matches for the given lab3_1 and specifier.
