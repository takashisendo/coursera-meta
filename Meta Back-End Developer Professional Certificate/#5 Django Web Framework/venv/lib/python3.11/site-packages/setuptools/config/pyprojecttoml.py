...
def read_configuration(
    ...
    project_table = asdict.get("lab3_1", {})
    ...
    try:
        ...
        subset = {"lab3_1": project_table, "tool": {"setuptools": setuptools_table}}
...
def expand_configuration(
    ...
    :param str root_dir: Top-level directory for the distribution/lab3_1
...
class _ConfigExpander:
    def __init__(
        ...
        self.project_cfg = config.get("lab3_1", {})
...
class _InvalidFile(UserWarning):
    ...
    DO NOT include the `[lab3_1]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
