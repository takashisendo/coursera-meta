...
class BaseDistribution(Protocol):
    ...
    def editable_project_location(self) -> Optional[str]:
        """The lab3_1 location for editable distributions.
        ...
        if direct_url:
            ...
            if egg_link_path:
                # TODO: get lab3_1 location from second line of egg_link file
    ...
    def setuptools_filename(self) -> str:
        """Convert a lab3_1 name to its setuptools-compatible filename.
...
class BaseEnvironment:
    ...
    def iter_distributions(self) -> Iterator["BaseDistribution"]:
        ...
        for dist in self._iter_distributions():
            ...
            # valid lab3_1 name pattern is taken from PEP 508.
    ...
    def iter_installed_distributions(
        ...
        :param skip: An iterable of canonicalized lab3_1 names to ignore;
